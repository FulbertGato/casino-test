...
if(__LOCALHOST) http = require('http').createServer(app); else {
    http = require('https').createServer({
        key: fs.readFileSync('/etc/letsencrypt/live/money1x.ru/privkey.pem', 'utf8'),
        cert: fs.readFileSync('/etc/letsencrypt/live/money1x.ru/fullchain.pem', 'utf8')
    }, app);
}
var io = require('socket.io')(http), domain = __LOCALHOST ? 'https://money1x.ru' : 'https://money1x.ru';
